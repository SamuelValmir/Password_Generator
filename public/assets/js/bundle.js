...
document.addEventListener("click", function (element) {
  ...
  if (target.classList.contains("generate_button")) {
    ...
    if (checkBoxCheckedList === undefined) {
      ...
      _tooltipErrorElement.style.opacity = 1;

      _tooltipErrorElement.setAttribute("data-showing", "true");

      return;
    }

    var password = _modules_Form__WEBPACK_IMPORTED_MODULE_2__["default"].generatePassword(charactersNumber, checkBoxCheckedList);
...
function fadeOut() {
  var tooltipErrorElement = document.querySelector(".tooltipError");
  var animation = tooltipErrorElement.animate([{
    "opacity": 0
  }], {
    duration: 100
  });
  animation.addEventListener("finish", function () {
    tooltipErrorElement.style.opacity = 0;
  });
}
